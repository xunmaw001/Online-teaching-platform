...
public class ZiliaoleixingController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ZiliaoleixingEntity ziliaoleixing, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ZiliaoleixingEntity ziliaoleixing, HttpServletRequest request){
        EntityWrapper<ZiliaoleixingEntity> ew = new EntityWrapper<ZiliaoleixingEntity>();
		PageUtils page = ziliaoleixingService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, ziliaoleixing), params), params));
        return R.ok().put("data", page);
    }
